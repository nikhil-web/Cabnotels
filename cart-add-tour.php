...
$sql = "INSERT INTO cart (id, cart_item_type, item_id, user_id, start_date, item_price, head_count,cab_type,room_type) VALUES (NULL,'2' ,'$tour_id' ,'$user_id' ,'$tour_start_date' ,'$tour_price' ,'$tour_head_count','$tour_cab_type','$tour_hotel_type')";
