<?php
     ...
     $output = 0;
      ...
      $tour_type = mysqli_real_escape_string($db,$_POST["tour_type"]);


      $output=0;
      $sql = "INSERT INTO tours (tour_id, tour_name, tour_loc, tour_about, tour_days, tour_nights,num_days,tour_price,tour_type) VALUES (NULL, '$tour_name','$tour_loc','$tour_about','$tour_days', '$tour_night','$num_days','$tour_price','$tour_type')";
