<?php
     ...
     $output = 0;
      ...
      $output=0;
      $sql = "INSERT INTO hotels (hotel_id, hotel_name, hotel_loc, hotel_add, hotel_email,hotel_number,hotel_stars,hotel_about) VALUES (NULL, '$hotel_name','$hotel_loc','$hotel_add', '$hotel_email', '$hotel_number', '$hotel_star','$hotel_about')";
