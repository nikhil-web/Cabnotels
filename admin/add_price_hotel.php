<?php
      ...
      $output=0;
      $sql = "INSERT INTO hotel_price (id,one,two,three,four,five,six,seven,eight,hotel_id) VALUES (NULL, '$p_one', '$p_two', '$p_three', '$p_four', '$p_five', '$p_six', '$p_seven', '$p_eight', '$hotel_id')";
