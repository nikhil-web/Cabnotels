              ...
              <div class="col-lg-12">
                <div class="row">
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-12 p-1">
                    ...
                    <input type="date" id="start_date" name="start_date" class="form-control  " value="<?php echo $start_date; ?>" placeholder="Enter Check In Date?"  pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" >
                  </div>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-12 p-1">
                      ...
                      <input type="date" id="end_date" name="end_date" class="form-control  " value="<?php echo $end_date; ?>"   pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}">
                  </div>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-12 p-1">
                      ...
                      <input id="adult_num" name="adult_num" type="number" class="form-control" max="10" min="1" value="<?php echo $adults_num; ?>" placeholder="No. Of Adults?">
                  </div>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-12 p-1">
                      ...
                      <input id="child_num" name="child_num" type="number" class="form-control" max="10" min="1" value="<?php echo $child_num; ?>" placeholder="No. Of Childern?" >
                  </div>
...
<div class=" clirle_button bottom">
  <div onclick="hide_search()" class="innside">
