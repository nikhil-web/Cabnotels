...
$adults = mysqli_real_escape_string($db,$_GET["adults"]);
$child = mysqli_real_escape_string($db,$_GET["child"]);
$cab = mysqli_real_escape_string($db,$_GET["cab"]);
...
$hotel = mysqli_real_escape_string($db,$_GET["hotel"]);
...
$id = mysqli_real_escape_string($db,$_GET["tour_id"]);
...
<html lang="en">
<head>
    <title>Cabnotels | Checkout Tour </title>
      ...
      <?php if ($login_flag == 1): ?>
        ...
        <div class="col-lg-8 py-4">
          ...
          <div id="card_body" class="card-body">
            ...
            <h5 class="card-title">Tour Booking</h5>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="border-0 align-middle"><strong>Rs. '.$price.'</strong></td>
                    <td class="border-0 align-middle">
                        <p><strong>People :</strong>'.$adults.'</p>

                        <p><strong>Date :</strong>'.$start_date.'</p>

                          <p><strong>Cab Type :</strong>'.$cab_type.'</p>

                            <p><strong>Room Type :</strong>'.$hotel_type.'</p>
         ...
         $.ajax({
             ...
             success: function(response) {
                 if (response == 0) {
                     ...
                     var query = "book_now_tour.php?tour_id=<?php echo $id; ?>&start_date=<?php echo $start_date; ?>&adults=<?php echo $adults; ?>&child=<?php echo  $child; ?>&cab=<?php echo $cab; ?>&hotel=<?php echo $hotel; ?>&price=<?php echo  $price; ?>";
                     window.location.href = query;
                     //tour_id=17&start_date=2019-09-06&adults=1&child=1&cab=2&hotel=2&price=48000
                     /*
